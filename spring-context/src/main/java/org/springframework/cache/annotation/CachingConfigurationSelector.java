...
public class CachingConfigurationSelector extends AdviceModeImportSelector<EnableCaching> {
	...
	/**
	 * Return the importSelector to use if the {@link AdviceMode} is set to {@link AdviceMode#PROXY}.
	...
	/**
	 * Return the importSelector to use if the {@link AdviceMode} is set to {@link AdviceMode#ASPECTJ}.
	 * <p>Take care of adding the necessary JSR-107 import if it is available.
	 */
